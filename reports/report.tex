...
% Prefer a restrained serif body similar to a traditional academic paper.
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\sffamily\small\color{mutedgray} Gaussian HMM לזיהוי משטרי שוק}
...
\vspace{0.8cm}
{\sffamily\Huge\bfseries\color{academicblue} Gaussian HMM לזיהוי משטרי שוק ולחיזוי כיוון יומי \par}
\vspace{0.65cm}
\begin{minipage}{0.82\textwidth}
\centering
{\sffamily\Large\color{deepnavy} ניתוח רב־נכסי, יציבות משטרים והשוואה למודלי בסיס ול־\LR{Supervised ML} \par}
\end{minipage}
\vspace{0.8cm}
{\color{linegray}\rule{0.82\textwidth}{0.8pt}}\par
